...
PAPER_QUERY_CASES = [
    ToolRoutingCase(
        ...
        forbidden_tools=["call_profile_synthesizer", "rank_papers_for_user"],
...
RANKING_CASES = [
    ToolRoutingCase(
        ...
        expected_tools=["rank_papers_for_user"],
...
NO_TOOL_CASES = [
    ToolRoutingCase(
        ...
        input="Hello!",
        expected_tools=[],
        forbidden_tools=["rank_papers_for_user", "call_profile_synthesizer", "create_github_summary"],
